...
export default function Robe(category) {
  const dispatch = useDispatch();
  const [boubou, setBoubou]=useState([])

  useEffect(()=>{
    
    const data= ApiCategoryShower.find(data=>data.categoryV=="Robes" && data.products)
  ...
  return (
    <div className="overflow-auto md:mt-[11vh] bg-gray-100  ">
      <div className="p-2 text-center text-2xl font-bold">ROBES</div>
